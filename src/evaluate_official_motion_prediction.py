...
def evaluate_official_prediction(
    ...
    with torch.no_grad():
        for step, raw_batch in enumerate(val_loader, start=1):
            ...
            miss_count_2m += int((min_fde_np > 2.0).sum())
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", default="/mnt/c/Users/andy0/Downloads/behavior_stack_planner/motion_prediction_model_v1/runs/full_30_epochs/checkpoints/best_minade6.pth")
    parser.add_argument("--data-root", default="/mnt/c/Users/andy0/Downloads/behavior_stack_planner/data/processed/prediction_pt")
