"""Load precomputed V10 collate tensors. Subsample targets at train time."""
...
from src.train_motion_prediction_v10 import (
    AGENT_DIM, HIST_STEPS, INTER_DIM, LANE_DIM, MAP_DIM, MAP_K,
    NEIGHBOR_HIST_DIM, NEIGHBOR_K, SIGNAL_K,
)
...
def try_cached_loader(cache_root: str, split: str, max_packs: int):
    ...
    try:
        ...
        return None
    return CachedSceneDataset(cache_root, split, max_packs, paths=paths)
